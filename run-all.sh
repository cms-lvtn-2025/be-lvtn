...
# Script để chạy tất cả services và server với Air
# Sử dụng: ./run-all.sh
...
echo -e "${BLUE}========================================${NC}"
echo -e "${GREEN}  Khởi động Services và Server với Air${NC}"
echo -e "${BLUE}========================================${NC}"
...
echo -e "  • Main Server:      ${PROJECT_ROOT}/logs/main-server.log"
