...
// ============================================
// REVIEWER QUERY METHODS
// ============================================

// GetMyGradeReviews returns grade reviews assigned to current teacher
func (c *Controller) GetMyGradeReviews(ctx context.Context, search *model.SearchRequestInput) (*model.GradeReviewListResponse, error) {
	myId, _, err := c.GetInfoRequest(ctx)
	if err != nil {
		return nil, err
	}
	...
	return &model.GradeReviewListResponse{
		...
		Data:  convert.PbGradeReviewsToModel(gradeReviews.GetGradeReviews()),
	}, nil
}
