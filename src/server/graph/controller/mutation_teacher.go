...
// ============================================
// REVIEWER MUTATION - Grade Review
// ============================================

// UpdateGradeReview updates a grade review
func (c *Controller) UpdateGradeReview(ctx context.Context, id string, input model.UpdateGradeReviewInput) (*model.GradeReview, error) {
	myId, check, err := c.RbacInfo(ctx, model.RoleSystemRoleTeacher)
	if err != nil {
		return nil, err
	}
	...
	if input.ReviewGrade != nil {
		req.ReviewGrade = input.ReviewGrade
	}
	if input.Notes != nil {
		req.Notes = input.Notes
	}
	...
	return convert.PbGradeReviewToModel(resp.GetGradeReview()), nil
}

// CompleteGradeReview marks grade review as complete
func (c *Controller) CompleteGradeReview(ctx context.Context, id string) (*model.GradeReview, error) {
	myId, check, err := c.RbacInfo(ctx, model.RoleSystemRoleTeacher)
	if err != nil {
		return nil, err
	}
