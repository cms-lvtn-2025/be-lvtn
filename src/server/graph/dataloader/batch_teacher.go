		...
		if err != nil {
			...
			for _, id := range ids {
				...
				if topicCouncil != nil && topicCouncil.TopicCouncil != nil {
					result[id] = convert2.PbTopicCouncilToCouncilTopicCouncil(topicCouncil.TopicCouncil)
				}
			}
			return result, nil
		}
		...
		if resp != nil && resp.TopicCouncils != nil {
			for _, pbTopicCouncil := range resp.TopicCouncils {
				if pbTopicCouncil != nil {
					result[pbTopicCouncil.Id] = convert2.PbTopicCouncilToCouncilTopicCouncil(pbTopicCouncil)
				}
			}
		}
	...
	return func(ctx context.Context, ids []string) (map[string]*model.ReviewerTopicCouncil, error) {
		...
		if err != nil {
			...
			for _, id := range ids {
				...
				if topicCouncil != nil && topicCouncil.TopicCouncil != nil {
					result[id] = convert2.PbTopicCouncilToReviewerTopicCouncil(topicCouncil.TopicCouncil)
				}
			}
			return result, nil
		}
		...
		if resp != nil && resp.TopicCouncils != nil {
			for _, pbTopicCouncil := range resp.TopicCouncils {
				if pbTopicCouncil != nil {
					result[pbTopicCouncil.Id] = convert2.PbTopicCouncilToReviewerTopicCouncil(pbTopicCouncil)
				}
			}
		}
	...
	return func(ctx context.Context, ids []string) (map[string]*model.SupervisorTopicCouncil, error) {
		...
		if err != nil {
			...
			for _, id := range ids {
				...
				if topicCouncil != nil && topicCouncil.TopicCouncil != nil {
					result[id] = convert2.PbTopicCouncilToSupervisorTopicCouncil(topicCouncil.TopicCouncil)
				}
			}
			return result, nil
		}
		...
		if resp != nil && resp.TopicCouncils != nil {
			for _, pbTopicCouncil := range resp.TopicCouncils {
				if pbTopicCouncil != nil {
					result[pbTopicCouncil.Id] = convert2.PbTopicCouncilToSupervisorTopicCouncil(pbTopicCouncil)
				}
			}
		}
	...
	return func(ctx context.Context, ids []string) (map[string]*model.ReviewerTopic, error) {
		...
		if err != nil {
			...
			for _, id := range ids {
				...
				if topic != nil && topic.Topic != nil {
					result[id] = convert2.PbTopicToReviewerTopic(topic.Topic)
				}
			}
			return result, nil
		}
		...
		if resp != nil && resp.Topics != nil {
			for _, pbTopic := range resp.Topics {
				if pbTopic != nil {
					result[pbTopic.Id] = convert2.PbTopicToReviewerTopic(pbTopic)
				}
			}
		}
	...
	return func(ctx context.Context, ids []string) (map[string]*model.SupervisorTopic, error) {
		...
		if err != nil {
			...
			for _, id := range ids {
				...
				if topic != nil && topic.Topic != nil {
					result[id] = convert2.PbTopicToSupervisorTopic(topic.Topic)
				}
			}
			return result, nil
		}
		...
		if resp != nil && resp.Topics != nil {
			for _, pbTopic := range resp.Topics {
				if pbTopic != nil {
					result[pbTopic.Id] = convert2.PbTopicToSupervisorTopic(pbTopic)
				}
			}
		}
