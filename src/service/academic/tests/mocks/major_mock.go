...
// MajorMock provides test implementations for Major operations
type MajorMock struct {
	*MockHandler
}

// NewMajorMock creates a new Major mock instance
func NewMajorMock(db *sql.DB) *MajorMock {
	return &MajorMock{
		MockHandler: NewMockHandler(db),
	}
}

// CreateMajor creates a new Major record (Test implementation)
func (m *MajorMock) CreateMajor(ctx context.Context, req *pb.CreateMajorRequest) (*pb.CreateMajorResponse, error) {
	...
	_, err := m.ExecQuery(ctx, query, id, req.Title, req.FacultyCode, req.CreatedBy)
...
// GetMajor retrieves a Major by ID (Test implementation)
func (m *MajorMock) GetMajor(ctx context.Context, req *pb.GetMajorRequest) (*pb.GetMajorResponse, error) {
	if req.Id == "" {
...
// ListMajors lists all majors (Test implementation)
func (m *MajorMock) ListMajors(ctx context.Context, req *pb.ListMajorsRequest) (*pb.ListMajorsResponse, error) {
...
// UpdateMajor updates a Major (Test implementation)
func (m *MajorMock) UpdateMajor(ctx context.Context, req *pb.UpdateMajorRequest) (*pb.UpdateMajorResponse, error) {
	if req.Id == "" {
		return nil, status.Error(codes.InvalidArgument, "id is required")
	}
	...
	// Get updated major
	getMajor, err := m.GetMajor(ctx, &pb.GetMajorRequest{Id: req.Id})
	if err != nil {
		return nil, err
	}
...
// DeleteMajor deletes a Major (Test implementation)
func (m *MajorMock) DeleteMajor(ctx context.Context, req *pb.DeleteMajorRequest) (*pb.DeleteMajorResponse, error) {
	if req.Id == "" {
		return nil, status.Error(codes.InvalidArgument, "id is required")
	}
