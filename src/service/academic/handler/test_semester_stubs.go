...
// CreateSemester creates a new Semester record (Test stub)
func (h *TestHandler) CreateSemester(ctx context.Context, req *pb.CreateSemesterRequest) (*pb.CreateSemesterResponse, error) {
...
// GetSemester retrieves a Semester by ID (Test stub)
func (h *TestHandler) GetSemester(ctx context.Context, req *pb.GetSemesterRequest) (*pb.GetSemesterResponse, error) {
	if req.Id == "" {
...
// ListSemesters lists all semesters (Test stub)
func (h *TestHandler) ListSemesters(ctx context.Context, req *pb.ListSemestersRequest) (*pb.ListSemestersResponse, error) {
...
// UpdateSemester updates a Semester (Test stub)
func (h *TestHandler) UpdateSemester(ctx context.Context, req *pb.UpdateSemesterRequest) (*pb.UpdateSemesterResponse, error) {
	if req.Id == "" {
		return nil, status.Error(codes.InvalidArgument, "id is required")
	}
	...
	getSemester, err := h.GetSemester(ctx, &pb.GetSemesterRequest{Id: req.Id})
	if err != nil {
		return nil, err
	}
...
// DeleteSemester deletes a Semester (Test stub)
func (h *TestHandler) DeleteSemester(ctx context.Context, req *pb.DeleteSemesterRequest) (*pb.DeleteSemesterResponse, error) {
	if req.Id == "" {
		return nil, status.Error(codes.InvalidArgument, "id is required")
	}
